...
<head>
	...
	<meta charset='utf-8'>
	<link rel="stylesheet" type="text/css" href="css/style_hope.css">
...
<body>
	<div class="header" id="sticky_header">
		...
		<a href="index.html" class="page_title_link">For The Love of Quote</a><br>
			...
			<?php
				...
				if (mysqli_num_rows($result) > 0 ) {
					...
					while($row = mysqli_fetch_assoc($result)) {
						...
						echo '<div class="mySlides fade"><div class="numbertext">' . $ln . ' / ' . $nrows . '</div><img src="'. $row["img_path"] . '" style="width:100%"></div>';
						$ln = $ln + 1;
					}
				} else {
					echo "0 results";
